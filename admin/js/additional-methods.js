...
jQuery.validator.addMethod("phoneID", function(value, element) {
	return this.optional(element) || /^(\+?62|0)\d{8,10}$/.test(value.replace(/\s+/g, ""));
}, "Please specify a valid phone number");

jQuery.validator.addMethod("mobileID", function(phone_number, element) {
	return this.optional(element) || phone_number.match(/^[+](628\d{8,10})$/);
...
//date format diantara
jQuery.validator.addMethod("dateID", function(date, element) {
    return this.optional(element) || date.match(/^(0[1-9]|[1-2][0-9]|3[0-1])-(0[1-9]|1[0-2])-[0-9]{4}$/);
